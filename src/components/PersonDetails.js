...
class PersonDetails extends Component {
  ...
  componentDidUpdate() {
    this.state.entityData.attributes.properties && this.state.entityData.attributes.properties.media && this.state.entityData.attributes.properties.media.images ?
      this.state.entityData.attributes.properties.media.images.map((image, index) =>
            ...
            <Col>
              <Row>
                <div id="personProfile">
                  ...
                  {this.state.entityData.attributes.properties && this.state.entityData.attributes.properties.profile ? <Col md={6}><div dangerouslySetInnerHTML={{ __html: this.state.entityData.attributes.properties.profile }} /></Col> : null}
                </div>
              </Row>
            </Col>
          </Row>
