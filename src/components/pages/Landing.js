  ...
  render() {
    ...
    return (
      <div className="landing" >
        ...
        <Container fluid>
          <div className='about'>
            <p><b>The Letters of Samuel Beckett, Emory University</b> is a project established to collect and consult as well as transcribe all extant letters by Samuel Beckett, and to publish the selected edition of <i>The Letters of Samuel Beckett</i> in four volumes with Cambridge University Press (2009-2016). The edition has been published in French (Gallimard) and German (Suhrkamp), and it is in publication in Italian (Adelphi) and Chinese (Hunan Literature and Art Press). The editorial project consulted and transcribed over 16,000 letters by Samuel Beckett. Since only about 20% of these letters are included in the selected edition, the question arose of how to make the research of more than thirty years available to future scholarship. Letters have two owners: the holder of the literary copyright and the owner of the physical property. Creating and sharing the metadata of Beckett’s letters respects these rights while describing the context and the content of the letters.  </p>
            <p><b>The Location Register of the Letters of Samuel Beckett in Public Archives</b> intends to make the descriptions of Beckett’s letters in public archives available to researchers and to the wider public. The first release of The Location Register was made possible by the support of The Gladys Krieble Delmas Foundation, Christopher Herbert and Nancy Welch, the College of Arts and Sciences of Emory University, Emory Libraries, LITS, and the Emory Center for Digital Scholarship. The second release added Beckett’s letters in Canadian, Irish, English and Scottish Public Archives. The third release, collections in continental and other international Public Archives, is delayed due to recent archival closures. The Location Register (https://beckett.library.emory.edu/) can be browsed by recipient, physical description, the places sent from and to, recipients (in original format and regularized to facilitate searching), language, repository, collection, and previous publication. Users can save pages in Word.</p>
